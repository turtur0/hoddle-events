...
export const metadata = {
  ...
  description:
    "Discover how Hoddle brings together concerts, theatre, sports and more across Melbourne. Set custom alerts, compare pricing and explore event trends."
};
...
const DATA_SOURCES = [
  {
    ...
    badge: { label: "Ticketing", variant: "default" as const },
    description:
      "Major concerts, sports events and theatre productions via the official Discovery API."
  },
  {
    name: "Fever",
    url: "https://feverup.com/en/australia",
    badge: { label: "Ticketing", variant: "default" as const },
    description:
      "Immersive exhibitions, experiences and cultural events via the Fever discovery platform."
  },
  {
    name: "Marriner Group",
    ...
    description:
      "Premium theatre, musicals and performing arts across Melbourne's finest venues.",
    venues: [
      "Regent Theatre",
      "Princess Theatre",
      "Comedy Theatre",
  ...
  },
  {
    ...
    badge: { label: "Curated", variant: "outline" as const },
    description:
      "Festivals, exhibitions and cultural events from the City of Melbourne."
  }
];
        ...
        <Card className="card-interactive">
          ...
          <CardContent className="space-y-4 text-base leading-relaxed">
            <p className="text-muted-foreground">
              Melbourne has an incredible cultural scene, but finding events
              shouldn't be as challenging as it is.
            </p>
            <p className="text-muted-foreground">
              Finding what's on often means checking multiple ticketing sites,
              signing up for endless newsletters, and manually tracking venues,
              or worse, missing your favourite artist because you found out too
              late. We thought there had to be a better way.
            </p>
            <p className="text-muted-foreground">
              Set custom alerts for what you actually care about, explore
              pricing trends across our entire database, and dive into our
              archive preserving Melbourne's cultural history for future
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {FEATURES.map((feature, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="p-5 rounded-xl border-2 bg-muted/30 transition-all hover:shadow-sm hover-lift"
                  >
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 rounded-xl border bg-muted/30">
              <p className="text-sm leading-relaxed text-muted-foreground">
                ...
                Events appearing on multiple platforms are automatically merged
                to show you the most complete information.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent>
            ...
            <ul className="grid gap-3 sm:grid-cols-2">
              {ETHICAL_PRACTICES.map((item, i) => (
                <li
                  key={i}
                  className="flex items-start gap-3 p-4 rounded-lg border bg-muted/30 transition-all hover:shadow-sm hover-lift"
                >
          ...
          <CardContent>
            ...
            <div className="flex flex-wrap gap-4 mb-6">
              <Button
                ...
                size="lg"
                asChild
                className="border-2 transition-all hover-lift"
              >
                <a
                  href="mailto:hoddlevents@gmail.com"
            ...
            <div className="p-4 rounded-xl border bg-muted/30">
              <p className="text-sm leading-relaxed text-muted-foreground">
                <strong className="text-foreground">Event organisers:</strong>{" "}
                Need your events removed? Contact us and we'll process your
