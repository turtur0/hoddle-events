        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto border-2 border-primary/30 bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-(--transition-base) group shadow-sm"
            >
            ...
            <Button
              ...
              size="lg"
              asChild
              className="w-full sm:w-auto border-2 border-secondary/30 bg-secondary/5 text-secondary hover:bg-secondary/10 hover:border-secondary/50 transition-all duration-(--transition-base) group"
            >
